...
export default function Cart() {
  ...
  return (
    <div className="relative p-2">
      ...
      <div
        className={`absolute top-2 right-1 flex justify-center items-center text-new-gray text-[0.8rem] font-bold bg-new-peach-100 rounded-full scale-100 duration-300 ${
