...
export default function Footer() {
  return (
    <footer className="flex items-center justify-center bg-black min-h-20">
      <div className="container max-w-[1400px] px-20 py-5 flex flex-col gap-4 sm:gap-0 sm:flex-row justify-evenly  items-center sm:items-start text-new-mint">
        <article className="relative w-28 h-28">
          <Image
            src="/logo.png"
            alt="logo"
            fill={true}
